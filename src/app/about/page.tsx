    ...
    <div className="mx-auto max-w-6xl px-5 py-12 sm:px-6 sm:py-16">
      <div className="grid gap-10 sm:grid-cols-3 sm:gap-12">
        <Reveal className="sm:col-span-1">
          <div className="relative mx-auto aspect-[3/4] w-full max-w-[18rem] overflow-hidden bg-neutral-100 sm:max-w-none dark:bg-neutral-900">
            <Image
            ...
            <div>
              ...
              <ul className="mt-4 flex flex-wrap gap-2">
                {profile.software.map((s) => (
                  <li
                    key={s}
                    className="border border-neutral-300 px-2.5 py-1 text-xs text-neutral-700 transition-colors hover:border-neutral-950 hover:text-neutral-950 dark:border-neutral-700 dark:text-neutral-300 dark:hover:border-neutral-50 dark:hover:text-neutral-50"
                  >
                    {s}
                  </li>
                ))}
              ...
              <h2 className="mt-8 text-sm uppercase tracking-widest text-neutral-500 dark:text-neutral-400">
                Design
              </h2>
